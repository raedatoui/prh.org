				...
				if (this._hasPause && !this._forcingPlayhead && !suppressEvents) {
					if (time >= prevTime) {
						...
						while (tween && tween._startTime <= time && !pauseTween) {
							if (!tween._duration) if (tween.data === "isPause" && !tween.ratio && !(tween._startTime === 0 && this$1._rawPrevTime === 0)) {
								pauseTween = tween;
							}
							tween = tween._next;
						}
	...
	_gsScope._gsDefine("TimelineMax", ["TimelineLite","TweenLite","easing.Ease"], function(TimelineLite, TweenLite, Ease) {
		...
		p.getLabelsArray = function() {
			...
			for (p in this._labels) {
				a[cnt++] = {time:this$1._labels[p], name:p};
			}
			a.sort(function(a,b) {
				...
				this.check = function(init) {
					...
					if (missing === 0 && func) {
						...
						if (global) {
							...
							if (!hasModule && typeof(undefined) === "function" && undefined.amd){ //AMD
		...
		var TweenLite = _class("TweenLite", function(target, duration, vars) {
				...
				if ((isSelector || target instanceof Array || (target.push && _isArray(target))) && typeof(target[0]) !== "number") {
					...
					for (i = 0; i < targets.length; i++) {
						...
						if (overwrite === 1) if (this$1._siblings[i].length > 1) {
		...
		var _lazyTweens = [],
			...
			_setRatio = function(v) {
				...
				var pt = this._firstPT,
					...
					val;
				while (pt) {
					val = !pt.blob ? pt.c * v + pt.s : (v === 1) ? this$1.end : v ? this$1.join("") : this$1.start;
					if (pt.m) {
		...
		p._initProps = function(target, propLookup, siblings, overwrittenProps, index) {
			...
			for (p in this.vars) {
				...
				if (_reservedProps[p]) {
					...
					//pr - priority		[number]
					//m - mod           [function | 0]
					this$1._firstPT = pt = {_next:this$1._firstPT, t:plugin, p:"setRatio", s:0, c:1, f:1, n:p, pg:1, pr:plugin._priority, m:0};
...
})(('object' !== "undefined" && module.exports && typeof(global) !== "undefined") ? global : this || window, "TweenMax");
});
...
})(('object' !== "undefined" && module.exports && typeof(global) !== "undefined") ? global : this || window, "TweenLite");
});
...
var modernizr = createCommonjsModule(function (module) {
/*!
 * modernizr v3.4.0
